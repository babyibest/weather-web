...
public class MoneyUtil {
	...
	public static void main(String args[]) {
		System.out.println(-99999999999999.999
				+ MoneyUtil.NumToRMBStr(-99999999999999.999));
		System.out.println(99999999999999.999 + MoneyUtil
				.NumToRMBStr(99999999999999.999));
		System.out.println(MoneyUtil.NumToRMBStr(100000000.00));
		System.out.println(MoneyUtil.NumToRMBStr(32906081.79));
