            ...
            <div id="left">
                ...
                <div class="media user-media hidden-phone">
                    <a href="" class="user-link">
                        <img src="common/assets/img/user.gif" alt="" class="media-object img-polaroid user-img">
                ...
                <ul id="menu" class="unstyled accordion collapse in">
                    <li class="accordion-group active">
                        <a data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#dashboard-nav">
                            <i class="icon-dashboard icon-large"></i> 订单管理
<!--                              <span  class="label label-inverse pull-right">2</span> -->
                        </a>
                        <ul class="collapse in" id="dashboard-nav">
                            <li><a href="viewOrders_projects.action"><i class="icon-angle-right"></i>订单状态</a></li>
                            <li><a href="viewOrders_projects.action"><i class="icon-angle-right"></i>订单配置</a></li>
                            <li><a href="viewOrders_projects.action"><i class="icon-angle-right"></i>财务信息</a></li>
                        </ul>
                    </li>
